                    ...
                    <tbody>
                        @foreach($permissions as $permission)
			                <tr>
			                    ...
			                    <td>
			                        @can('show_roles')
			                            <a href="{{ route('permisos.show', $permission->id)}}" class="btn btn-xs btn-primary" style="margin-top: 15px">
			                                Ver
			                            </a>
			                        @endcan
			                        @can('edit_roles')
			                            <a href="{{ route('permisos.edit', $permission->id)}}" class="btn btn-xs btn-warning" style="margin-top: 15px">
			                                Editar
			                            </a>
			                        @endcan
			                        @can('delete_roles')
			                            <form action="{{ route('permisos.destroy', $permission->id) }}"
					        				...
					        				<button title="Eliminar" class="btn btn-xs btn-danger" style="margin-top: 15px">
					        					Eliminar
					        				</button>
					        			</form>
			                        @endcan
