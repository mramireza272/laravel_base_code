...
<style>
body {
	background-image: url(img/bg-img/gris.jpg);
        ...
        <div class="col-md-5 col-lg-4">
          <div class="card bg-dark border-0 mb-0">
            <div class="card-header bg- pb-5">
              ...
              <img src="/img/logos/logo_ach.png" class="img-responsive">
              </div>
            </div>
            <div class="card-body px-lg-7 py-lg-5">
              <div class="text-center text-muted mb-4">
					<div class="text-center text-muted mb-3">
		                <h1 style="font-size:20px; color: #ffffff">Project</h1>
		            ...
		            <form method="POST" action="/login">
		                ...
		                <button class="btn btn-primary btn-lg btn-block" type="submit" id="btn-login">Ingresar</button>
		            </form>
		            <br>
		            @if(Session::has('msg'))
