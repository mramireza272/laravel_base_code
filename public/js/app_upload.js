...
if ($uploadList.length > 0 && $fileUpload.length > 0) {
    ...
    $fileUpload.fileupload({
        ...
        progressall: function progressall(e, data) {
            ...
            $("#" + data.theId).text('Cargando ' + progress + '%');
        },
        add: function add(e, data) {
            data._progress.theId = 'id_' + idSequence;
            idSequence++;
            $uploadList.append($('<li id="' + data.theId + '"></li>').text('Cargando'));
            data.submit();
        },
        done: function done(e, data) {
            $uploadList.append($('<li></li>').text('Cargado: ' + data.result.path + ' ' + data.result.name));
        }
    });
}
