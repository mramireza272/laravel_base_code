  ...
  pluginInit: ->
    ...
    if @options.showViewPermissionsCheckbox == true
      @annotator.editor.addField({
        type:   'checkbox'
        label:  Annotator._t('Permitir que cualquiera <strong>vea</strong> esta anotación')
    ...
    if @options.showEditPermissionsCheckbox == true
      @annotator.editor.addField({
        type:   'checkbox'
        label:  Annotator._t('Permitir que cualquiera <strong>edite</strong> esta anotación')
